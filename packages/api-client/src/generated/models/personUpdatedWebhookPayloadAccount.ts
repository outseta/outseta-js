// @ts-nocheck
import type { PersonUpdatedWebhookPayloadAccountAccountStage } from './personUpdatedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonUpdatedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonUpdatedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
