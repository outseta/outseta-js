// @ts-nocheck
import type { PersonEmailBounceWebhookPayloadAccountAccountStage } from './personEmailBounceWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonEmailBounceWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonEmailBounceWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
