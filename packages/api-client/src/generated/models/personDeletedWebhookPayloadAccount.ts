// @ts-nocheck
import type { PersonDeletedWebhookPayloadAccountAccountStage } from './personDeletedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonDeletedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonDeletedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
