// @ts-nocheck
import type { DiscordUserLinkedWebhookPayloadAccountAccountStage } from './discordUserLinkedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type DiscordUserLinkedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: DiscordUserLinkedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
