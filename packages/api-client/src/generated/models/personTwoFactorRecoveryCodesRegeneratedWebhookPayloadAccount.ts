// @ts-nocheck
import type { PersonTwoFactorRecoveryCodesRegeneratedWebhookPayloadAccountAccountStage } from './personTwoFactorRecoveryCodesRegeneratedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonTwoFactorRecoveryCodesRegeneratedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonTwoFactorRecoveryCodesRegeneratedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
