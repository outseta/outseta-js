// @ts-nocheck
import type { DealCreatedWebhookPayloadAccountAccountStage } from './dealCreatedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type DealCreatedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: DealCreatedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
