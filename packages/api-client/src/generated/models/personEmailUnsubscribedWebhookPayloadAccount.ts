// @ts-nocheck
import type { PersonEmailUnsubscribedWebhookPayloadAccountAccountStage } from './personEmailUnsubscribedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonEmailUnsubscribedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonEmailUnsubscribedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
