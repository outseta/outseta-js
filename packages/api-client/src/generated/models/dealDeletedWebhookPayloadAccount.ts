// @ts-nocheck
import type { DealDeletedWebhookPayloadAccountAccountStage } from './dealDeletedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type DealDeletedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: DealDeletedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
