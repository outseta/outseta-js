// @ts-nocheck
import type { PersonEmailOpenedWebhookPayloadAccountAccountStage } from './personEmailOpenedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonEmailOpenedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonEmailOpenedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
