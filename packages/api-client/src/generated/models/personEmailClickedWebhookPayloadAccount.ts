// @ts-nocheck
import type { PersonEmailClickedWebhookPayloadAccountAccountStage } from './personEmailClickedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonEmailClickedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonEmailClickedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
