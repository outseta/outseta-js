// @ts-nocheck
import type { PersonEmailSubscribedWebhookPayloadAccountAccountStage } from './personEmailSubscribedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonEmailSubscribedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonEmailSubscribedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
