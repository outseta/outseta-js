// @ts-nocheck
import type { DealUpdatedWebhookPayloadAccountAccountStage } from './dealUpdatedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type DealUpdatedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: DealUpdatedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
