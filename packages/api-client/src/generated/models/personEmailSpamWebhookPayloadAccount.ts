// @ts-nocheck
import type { PersonEmailSpamWebhookPayloadAccountAccountStage } from './personEmailSpamWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonEmailSpamWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonEmailSpamWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
