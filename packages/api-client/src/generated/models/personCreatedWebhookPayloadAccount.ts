// @ts-nocheck
import type { PersonCreatedWebhookPayloadAccountAccountStage } from './personCreatedWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonCreatedWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonCreatedWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
