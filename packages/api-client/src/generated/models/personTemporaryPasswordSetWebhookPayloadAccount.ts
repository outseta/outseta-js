// @ts-nocheck
import type { PersonTemporaryPasswordSetWebhookPayloadAccountAccountStage } from './personTemporaryPasswordSetWebhookPayloadAccountAccountStage';

/**
 * @nullable
 */
export type PersonTemporaryPasswordSetWebhookPayloadAccount = {
  /**
   * @maxLength 10
   * @nullable
   */
  ...
  AccountStage?: PersonTemporaryPasswordSetWebhookPayloadAccountAccountStage;
  /**
   * @maxLength 50
   * @nullable
   */
