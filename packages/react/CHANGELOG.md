...
- 7b2f7ee: Update API spec.
- Updated dependencies [7b2f7ee]
  - @outseta/api-client@0.3.44

## 0.4.37

### Patch Changes

- 15c3d76: Update API spec.
- Updated dependencies [15c3d76]
  - @outseta/api-client@0.3.43

## 0.4.36

### Patch Changes

- 583e688: Update API spec.
- Updated dependencies [583e688]
  - @outseta/api-client@0.3.42

## 0.4.35

### Patch Changes

- 1c0bf00: Update API spec.
- Updated dependencies [1c0bf00]
  - @outseta/api-client@0.3.41

## 0.4.34

### Patch Changes

- f9bc21b: Update API spec.
- Updated dependencies [f9bc21b]
  - @outseta/api-client@0.3.40

## 0.4.33

### Patch Changes

- 09bbad2: Update API spec.
- Updated dependencies [09bbad2]
  - @outseta/api-client@0.3.39

## 0.4.32

### Patch Changes

- f538185: Update API spec.
- Updated dependencies [f538185]
  - @outseta/api-client@0.3.38

## 0.4.31

### Patch Changes

- cc2ad47: Update API spec.
- Updated dependencies [cc2ad47]
  - @outseta/api-client@0.3.37

## 0.4.30

### Patch Changes

- 86ed2a2: Update API spec.
- Updated dependencies [86ed2a2]
  - @outseta/api-client@0.3.36
...
- fa9347e: Update API spec.
- Updated dependencies [fa9347e]
  - @outseta/api-client@0.3.34

## 0.4.27

### Patch Changes

- 89fbe0e: Update API spec.
- Updated dependencies [89fbe0e]
  - @outseta/api-client@0.3.33

## 0.4.26

### Patch Changes

- a99221a: Update API spec.
- Updated dependencies [a99221a]
  - @outseta/api-client@0.3.32

## 0.4.25

### Patch Changes

- d5e2888: Update API spec.
- Updated dependencies [d5e2888]
  - @outseta/api-client@0.3.31

## 0.4.24

### Patch Changes

- 3b14ac0: Update API spec.
- Updated dependencies [3b14ac0]
  - @outseta/api-client@0.3.30

## 0.4.23

### Patch Changes

- 903dd5e: Update API spec.
...
- 59ea07b: Update API spec.
- Updated dependencies [59ea07b]
  - @outseta/api-client@0.3.28

## 0.4.21

### Patch Changes

- f2761d8: Update API spec.
- Updated dependencies [f2761d8]
  - @outseta/api-client@0.3.27

## 0.4.20

### Patch Changes

- 51ea4d3: Update API spec.
- Updated dependencies [51ea4d3]
  - @outseta/api-client@0.3.26
...
- 677d41e: Update API spec.
- Updated dependencies [677d41e]
  - @outseta/api-client@0.3.24

## 0.4.17

### Patch Changes

- f2c1dd5: Update API spec.
- Updated dependencies [f2c1dd5]
  - @outseta/api-client@0.3.23

## 0.4.16

### Patch Changes

- a9e5939: Update API spec.
- Updated dependencies [a9e5939]
  - @outseta/api-client@0.3.22

## 0.4.15

### Patch Changes

- b9808f2: Update API spec.
- Updated dependencies [b9808f2]
  - @outseta/api-client@0.3.21
